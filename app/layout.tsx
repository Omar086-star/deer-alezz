...
export const metadata: Metadata = {
  ...
  description:
    "حملة إنسانية شاملة لإعادة إعمار دير الزور وجمع 5 مليون دولار للبنية التحتية والخدمات الأساسية. نعمل في 7 مجالات: البنية التحتية، الأمن، الإسكان، الصحة، التعليم، الأمن الغذائي والخدمات المجتمعية.",
  keywords: [
    "دير الزور",
    "إعادة الإعمار",
    "حملة إنسانية",
